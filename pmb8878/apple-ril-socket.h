/**
 * This file is part of iphone-ril.
 *
...
/* iPhone RIL Socket protocol defines */

#ifndef _IPHONE_RIL_SOCKET_H_
#define _IPHONE_RIL_SOCKET_H_

#define SRS_COMMAND(f)  ((f->group << 8) | f->index)
#define SRS_GROUP(m)    (m >> 8)
#define SRS_INDEX(m)    (m & 0xff)

#define SRS_SOCKET_NAME			"iphone-ril-socket"
